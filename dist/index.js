  ...
  return /* @__PURE__ */ jsxs3("div", { className: cn("relative", className), children: [
    /* @__PURE__ */ jsx12(
      "span",
      {
        ...
        "aria-hidden": "true",
        children: /* @__PURE__ */ jsx12("svg", { className: "size-5", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ jsx12(
          "path",
          {
    ...
    hasValue && !disabled && /* @__PURE__ */ jsx12(
      "button",
      {
        type: "button",
...
var Select = ({
  ...
  return /* @__PURE__ */ jsx13(
    FormField,
    {
      ...
      htmlFor: selectId,
      "aria-describedby": ariaDescribedBy,
      children: ({ describedBy }) => /* @__PURE__ */ jsxs4("div", { className: "relative", children: [
        /* @__PURE__ */ jsxs4(
          "select",
          {
            id: selectId,
            ...
            children: [
              placeholder && /* @__PURE__ */ jsx13("option", { value: "", disabled: !clearable, children: placeholder }),
  ...
  return /* @__PURE__ */ jsx14(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs5("div", { className: "text-center", children: [
        ...
        label && /* @__PURE__ */ jsx14("p", { className: "text-gray-600 dark:text-gray-300 text-sm", children: label })
      ] })
    }
  );
};
        ...
        "div",
        {
          ...
          children: [
            (title || !hideCloseButton) && /* @__PURE__ */ jsxs7("div", { className: "flex justify-between items-center p-6 pb-4", children: [
              title && /* @__PURE__ */ jsx18("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white", children: title }),
            ...
            /* @__PURE__ */ jsx18("div", { className: title || !hideCloseButton ? "px-6 pb-6" : "p-6", children })
          ]
        }
      )
    }
...
var DefaultIcon = ({ className }) => /* @__PURE__ */ jsx19(
  "svg",
  {
    className,
    fill: "none",
    ...
    Dialog,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs8("div", { className: "flex items-center mb-4", children: [
          /* @__PURE__ */ jsx19(
            "div",
            {
              ...
              children: icon || /* @__PURE__ */ jsx19(DefaultIcon, { className: cn("h-6 w-6", styles.iconColor) })
            }
          ),
          /* @__PURE__ */ jsx19(
            Heading,
        ...
        /* @__PURE__ */ jsxs8("div", { className: "mb-6", children: [
          /* @__PURE__ */ jsx19(Typography, { as: "div", children: message }),
          description && /* @__PURE__ */ jsx19(Typography, { className: "mt-2", variant: "body-sm", tone: "muted", children: description })
        ] }),
...
var renderActions = (row, actions) => {
  ...
  return /* @__PURE__ */ jsx20("div", { className: "flex flex-wrap items-center justify-end gap-2", children: resolvedActions.map((action) => /* @__PURE__ */ jsx20(
    Button,
    {
      type: "button",
      size: "small",
...
var DataTable = ({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsx20("div", { className: cn("w-full", className), "aria-busy": "true", children: /* @__PURE__ */ jsx20(Spinner, { label: loadingLabel }) });
  }
  if (mobileMode === "cards") {
    return /* @__PURE__ */ jsxs9("div", { className: cn("w-full", className), children: [
      /* @__PURE__ */ jsx20("div", { className: "hidden md:block overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700", children: /* @__PURE__ */ jsxs9("table", { className: "min-w-full border-collapse", children: [
        /* @__PURE__ */ jsx20("thead", { className: "bg-gray-50 dark:bg-gray-800/60", children: /* @__PURE__ */ jsxs9("tr", { children: [
          ...
          hasActionColumn && /* @__PURE__ */ jsx20("th", { className: "px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-gray-600 dark:text-gray-300", children: actionHeader })
        ] }) }),
        /* @__PURE__ */ jsx20("tbody", { className: "divide-y divide-gray-200 dark:divide-gray-700", children: rows.length === 0 ? /* @__PURE__ */ jsx20("tr", { children: /* @__PURE__ */ jsx20(
          "td",
          {
            colSpan: tableColumnCount,
            className: "px-4 py-8 text-center text-sm text-gray-500 dark:text-gray-400",
            children: /* @__PURE__ */ jsx20(Typography, { as: "span", tone: "muted", children: emptyMessage })
          }
        ) }) : rows.map((row, index) => /* @__PURE__ */ jsxs9(
          "tr",
          {
            ...
            children: [
              ...
              hasActionColumn && /* @__PURE__ */ jsx20("td", { className: "px-4 py-3 text-right", children: renderActions(row, actions) })
            ]
          },
          getRowId(row, index)
        )) })
      ] }) }),
      /* @__PURE__ */ jsx20("div", { className: "space-y-3 md:hidden", children: rows.length === 0 ? /* @__PURE__ */ jsx20("div", { className: "rounded-lg border border-dashed border-gray-300 bg-gray-50 px-4 py-8 text-center dark:border-gray-700 dark:bg-gray-900/50", children: /* @__PURE__ */ jsx20(Typography, { as: "p", tone: "muted", children: emptyMessage }) }) : rows.map((row, index) => /* @__PURE__ */ jsxs9(
        "div",
        {
          className: "rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900",
          children: [
            /* @__PURE__ */ jsx20("dl", { className: "space-y-3", children: columns.map((column) => /* @__PURE__ */ jsxs9("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsx20("dt", { className: "text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400", children: column.mobileLabel ?? column.header }),
              /* @__PURE__ */ jsx20(
                "dd",
                {
                  className: cn(
            ...
            hasActionColumn && /* @__PURE__ */ jsx20("div", { className: "mt-4", children: renderActions(row, actions) })
          ]
        },
        getRowId(row, index)
      )) })
  ...
  return /* @__PURE__ */ jsx20(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs9("table", { className: "min-w-full border-collapse", children: [
        /* @__PURE__ */ jsx20("thead", { className: "bg-gray-50 dark:bg-gray-800/60", children: /* @__PURE__ */ jsxs9("tr", { children: [
          columns.map((column) => /* @__PURE__ */ jsx20(
            "th",
            {
...
var DefaultCloseIcon = () => /* @__PURE__ */ jsx22(
  "svg",
  {
    className: "w-5 h-5",
    fill: "none",
...
var DefaultSearchIcon = () => /* @__PURE__ */ jsx22(
  "svg",
  {
    className: "w-5 h-5",
    fill: "none",
...
var DefaultFilterIcon = () => /* @__PURE__ */ jsx22(
  "svg",
  {
    className: "w-5 h-5",
    fill: "none",
...
var DefaultAddIcon = () => /* @__PURE__ */ jsx22(
  "svg",
  {
    className: "w-5 h-5",
    fill: "none",
...
var ListLayout = ({
  ...
  const SearchIconComponent = searchIcon || /* @__PURE__ */ jsx22(DefaultSearchIcon, {});
  const FilterIconComponent = filterIcon || /* @__PURE__ */ jsx22(DefaultFilterIcon, {});
  const AddIconComponent = addIcon || /* @__PURE__ */ jsx22(DefaultAddIcon, {});
  const CloseIconComponent = closeIcon || /* @__PURE__ */ jsx22(DefaultCloseIcon, {});
  return /* @__PURE__ */ jsxs10("div", { className: cn("max-w-3xl mx-auto p-4", className), children: [
    /* @__PURE__ */ jsxs10("div", { className: "flex justify-between items-center mb-4", children: [
      /* @__PURE__ */ jsx22(
        Heading,
        {
          as: "h1",
      ...
      /* @__PURE__ */ jsxs10("div", { className: "flex gap-2", children: [
        ...
        enableIncompleteFilter && /* @__PURE__ */ jsx22(
          "button",
          {
        ...
        onToggleAddForm ? /* @__PURE__ */ jsx22(
          "button",
          {
    ...
    errorMessage && onClearError && /* @__PURE__ */ jsxs10("div", { className: "bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 p-3 rounded-lg mb-4 flex justify-between items-center animate-kui-slide-down shadow-sm", children: [
      /* @__PURE__ */ jsx22(Typography, { as: "p", tone: "danger", children: errorMessage }),
      /* @__PURE__ */ jsx22(
        "button",
        {
    ...
    enableIncompleteFilter && showFilterOptions && /* @__PURE__ */ jsxs10("div", { className: "mb-4 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg shadow-sm p-3 animate-kui-slide-down", children: [
      ...
      onToggleIncomplete && /* @__PURE__ */ jsx22("div", { className: "mt-3", children: /* @__PURE__ */ jsxs10("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsx22(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ jsx22("label", { htmlFor: "showOnlyIncomplete", className: "ml-2", children: /* @__PURE__ */ jsx22(Typography, { as: "span", children: incompleteFilterLabel }) })
      ] }) })
    ] }),
    showSearchForm && /* @__PURE__ */ jsxs10("div", { className: "mb-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3 relative animate-kui-slide-down", children: [
      /* @__PURE__ */ jsxs10("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsx22("span", { className: "w-5 h-5 text-gray-400 dark:text-gray-500 absolute left-6", children: SearchIconComponent }),
        /* @__PURE__ */ jsx22(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsx22("div", { className: "flex justify-end mt-3", children: /* @__PURE__ */ jsx22(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsx22(Typography, { as: "span", variant: "body-sm", tone: "info", children: closeSearchLabel })
        }
      ) })
    ] }),
    showAddForm && addFormComponent && /* @__PURE__ */ jsx22("div", { className: "mb-4", children: addFormComponent }),
    statsComponent && /* @__PURE__ */ jsx22("div", { className: "mb-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm", children: statsComponent }),
    isLoading && /* @__PURE__ */ jsx22("div", { className: "flex justify-center items-center py-8", children: /* @__PURE__ */ jsx22("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500 dark:border-blue-400" }) }),
    isError && onReload && /* @__PURE__ */ jsxs10("div", { className: "text-center py-8 text-red-500 dark:text-red-400 bg-red-50 dark:bg-red-900/30 rounded-lg", children: [
      /* @__PURE__ */ jsx22(Typography, { as: "p", tone: "danger", children: errorFetchMessage }),
      /* @__PURE__ */ jsx22(
        "button",
        {
          onClick: onReload,
          ...
          children: /* @__PURE__ */ jsx22(Typography, { as: "span", variant: "body-sm", tone: "danger", children: reloadLabel })
        }
      )
    ] }),
    !isLoading && !isError && /* @__PURE__ */ jsx22("div", { className: "space-y-3", children: hasItems ? children : /* @__PURE__ */ jsx22("div", { className: "text-center py-8 text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-lg animate-kui-fade-in", children: searchKeyword ? /* @__PURE__ */ jsx22(Typography, { as: "p", tone: "muted", children: noSearchResultsMessage }) : showOnlyIncomplete ? /* @__PURE__ */ jsx22(Typography, { as: "p", tone: "muted", children: noIncompleteMessage }) : /* @__PURE__ */ jsx22(Typography, { as: "p", tone: "muted", children: emptyMessage }) }) })
  ] });
};
  ...
  return /* @__PURE__ */ jsxs11("div", { className: cn("flex items-center gap-2", className), children: [
    ...
    /* @__PURE__ */ jsx23(
      "select",
      {
        ...
        children: monthOptions.map((option) => /* @__PURE__ */ jsx23("option", { value: option.value, children: option.label }, option.value))
      }
    ),
    /* @__PURE__ */ jsx23(
      "button",
...
var defaultRenderLink = ({
  ...
  className,
  onClick
}) => /* @__PURE__ */ jsx24("a", { href, className, onClick, children });
  ...
  return /* @__PURE__ */ jsxs12(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs12(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx24(DrawerHeader, { children: /* @__PURE__ */ jsx24(
            "button",
            {
              onClick: onClose,
          ...
          /* @__PURE__ */ jsxs12("div", { className: "overflow-y-auto h-full pb-16", children: [
            sections.map((section, sectionIndex) => /* @__PURE__ */ jsxs12("div", { children: [
              /* @__PURE__ */ jsx24("div", { className: "text-sm text-gray-500 dark:text-gray-400 px-4 pt-2", children: section.title }),
              section.items.map((item) => /* @__PURE__ */ jsx24("div", { className: "px-2", children: renderLink({
                href: item.path,
                ...
                onClick: onClose,
                children: /* @__PURE__ */ jsxs12(Fragment, { children: [
                  item.icon && /* @__PURE__ */ jsx24("span", { className: "text-gray-500 dark:text-gray-400 mr-3", children: item.icon }),
                  /* @__PURE__ */ jsx24("span", { children: item.name })
                ] })
              }) }, item.name))
            ] }, section.title || `section-${sectionIndex}`)),
            onLogout && /* @__PURE__ */ jsx24("div", { className: "px-2 mt-4", children: /* @__PURE__ */ jsx24(
              "button",
              {
                ...
                onClick: onLogout,
                children: /* @__PURE__ */ jsx24("span", { children: logoutLabel })
              }
            ) })
          ] })
        ]
...
var StatCards = ({
  ...
  return /* @__PURE__ */ jsx25("div", { className: cn("grid gap-4", columnStyles[columns], className), children: cards.map((card) => {
    ...
    return /* @__PURE__ */ jsxs13(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx25("h3", { className: cn("text-sm font-medium mb-1", styles.text), children: card.label }),
          /* @__PURE__ */ jsx25("p", { className: cn("text-2xl font-bold", styles.text), children: formatValue(card.value) })
        ]
      },
      card.label
    );
...
var Tooltip = ({
  ...
  return /* @__PURE__ */ jsxs14("div", { className: cn("relative inline-block", className), ref: tooltipRef, children: [
    /* @__PURE__ */ jsx26(
      "button",
      {
        ref: buttonRef,
    ...
    isOpen && /* @__PURE__ */ jsxs14(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx26("div", { className: "p-3 text-sm text-gray-700 dark:text-gray-200", children: content }),
          /* @__PURE__ */ jsx26("div", { className: arrowClass, "aria-hidden": "true" })
        ]
      }
    )
  ] });
...
var AppLayout = ({
  ...
  const titleContent = /* @__PURE__ */ jsx27("span", { className: "text-xl font-bold text-primary-main dark:text-white", children: appTitle });
  const defaultRenderLink2 = ({
    href,
    children: linkChildren
  }) => /* @__PURE__ */ jsx27("a", { href, children: linkChildren });
  const linkRenderer = renderLink || defaultRenderLink2;
  return /* @__PURE__ */ jsxs15("div", { className: "flex min-h-screen bg-white dark:bg-gray-900", children: [
    /* @__PURE__ */ jsx27(AppBar, { position: "fixed", color: appBarColor, className: "shadow-none", children: /* @__PURE__ */ jsxs15("div", { className: "flex items-center justify-between px-4 py-2", children: [
      /* @__PURE__ */ jsxs15("h6", { className: "text-xl font-bold grow", children: [
        linkRenderer({
          href: titleHref,
  ...
  return /* @__PURE__ */ jsxs16(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx28(Heading, { as: "h2", size: headingSizeMap[size], children: title }),
        ...
        action && actionPlacement === "inline" ? /* @__PURE__ */ jsx28("div", { children: action }) : null,
        action && actionPlacement === "below" ? /* @__PURE__ */ jsx28("div", { className: cn("flex w-full pt-1", actionWrapAlignClassMap[align]), children: action }) : null
      ]
    }
  );
};
