      ...
      /* @__PURE__ */ jsxs3(
        "select",
        {
          ...
          children: [
            ...
            options.map((option) => /* @__PURE__ */ jsx11(
              "option",
              {
                value: option.value,
  ...
  return /* @__PURE__ */ jsx12(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs4("div", { className: "text-center", children: [
        ...
        label && /* @__PURE__ */ jsx12("p", { className: "text-gray-600 dark:text-gray-300 text-sm", children: label })
      ] })
    }
  );
};
        ...
        "div",
        {
          ...
          children: [
            (title || !hideCloseButton) && /* @__PURE__ */ jsxs7("div", { className: "flex justify-between items-center p-6 pb-4", children: [
              title && /* @__PURE__ */ jsx16("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white", children: title }),
              !hideCloseButton && /* @__PURE__ */ jsx16(
                "button",
                {
                  onClick: onClose,
            ...
            /* @__PURE__ */ jsx16("div", { className: title || !hideCloseButton ? "px-6 pb-6" : "p-6", children })
          ]
        }
      )
    }
...
var DefaultIcon = ({ className }) => /* @__PURE__ */ jsx17(
  "svg",
  {
    className,
    fill: "none",
    ...
    Dialog,
    {
      ...
      children: [
        /* @__PURE__ */ jsxs8("div", { className: "flex items-center mb-4", children: [
          /* @__PURE__ */ jsx17(
            "div",
            {
              ...
              children: icon || /* @__PURE__ */ jsx17(DefaultIcon, { className: cn("h-6 w-6", styles.iconColor) })
            }
          ),
          /* @__PURE__ */ jsx17(
            Heading,
        ...
        /* @__PURE__ */ jsxs8("div", { className: "mb-6", children: [
          /* @__PURE__ */ jsx17(Typography, { as: "div", children: message }),
          description && /* @__PURE__ */ jsx17(Typography, { className: "mt-2", variant: "body-sm", tone: "muted", children: description })
        ] }),
...
var DefaultCloseIcon = () => /* @__PURE__ */ jsx19(
  "svg",
  {
    className: "w-5 h-5",
    fill: "none",
...
var DefaultSearchIcon = () => /* @__PURE__ */ jsx19(
  "svg",
  {
    className: "w-5 h-5",
    fill: "none",
...
var DefaultFilterIcon = () => /* @__PURE__ */ jsx19(
  "svg",
  {
    className: "w-5 h-5",
    fill: "none",
...
var DefaultAddIcon = () => /* @__PURE__ */ jsx19(
  "svg",
  {
    className: "w-5 h-5",
    fill: "none",
...
var ListLayout = ({
  ...
  const SearchIconComponent = searchIcon || /* @__PURE__ */ jsx19(DefaultSearchIcon, {});
  const FilterIconComponent = filterIcon || /* @__PURE__ */ jsx19(DefaultFilterIcon, {});
  const AddIconComponent = addIcon || /* @__PURE__ */ jsx19(DefaultAddIcon, {});
  const CloseIconComponent = closeIcon || /* @__PURE__ */ jsx19(DefaultCloseIcon, {});
  return /* @__PURE__ */ jsxs9("div", { className: cn("max-w-3xl mx-auto p-4", className), children: [
    /* @__PURE__ */ jsxs9("div", { className: "flex justify-between items-center mb-4", children: [
      ...
      /* @__PURE__ */ jsxs9("div", { className: "flex gap-2", children: [
        ...
        enableIncompleteFilter && /* @__PURE__ */ jsx19(
          "button",
          {
        ...
        onToggleAddForm ? /* @__PURE__ */ jsx19(
          "button",
          {
    ...
    errorMessage && onClearError && /* @__PURE__ */ jsxs9("div", { className: "bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 p-3 rounded-lg mb-4 flex justify-between items-center animate-kui-slide-down shadow-sm", children: [
      /* @__PURE__ */ jsx19(Typography, { as: "p", tone: "danger", children: errorMessage }),
      /* @__PURE__ */ jsx19(
        "button",
        {
    ...
    enableIncompleteFilter && showFilterOptions && /* @__PURE__ */ jsxs9("div", { className: "mb-4 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg shadow-sm p-3 animate-kui-slide-down", children: [
      ...
      onToggleIncomplete && /* @__PURE__ */ jsx19("div", { className: "mt-3", children: /* @__PURE__ */ jsxs9("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsx19(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ jsx19("label", { htmlFor: "showOnlyIncomplete", className: "ml-2", children: /* @__PURE__ */ jsx19(Typography, { as: "span", children: incompleteFilterLabel }) })
      ] }) })
    ] }),
    showSearchForm && /* @__PURE__ */ jsxs9("div", { className: "mb-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm p-3 relative animate-kui-slide-down", children: [
      /* @__PURE__ */ jsxs9("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsx19("span", { className: "w-5 h-5 text-gray-400 dark:text-gray-500 absolute left-6", children: SearchIconComponent }),
        /* @__PURE__ */ jsx19(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsx19("div", { className: "flex justify-end mt-3", children: /* @__PURE__ */ jsx19(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsx19(Typography, { as: "span", variant: "body-sm", tone: "info", children: closeSearchLabel })
        }
      ) })
    ] }),
    showAddForm && addFormComponent && /* @__PURE__ */ jsx19("div", { className: "mb-4", children: addFormComponent }),
    statsComponent && /* @__PURE__ */ jsx19("div", { className: "mb-6 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm", children: statsComponent }),
    isLoading && /* @__PURE__ */ jsx19("div", { className: "flex justify-center items-center py-8", children: /* @__PURE__ */ jsx19("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-blue-500 dark:border-blue-400" }) }),
    isError && onReload && /* @__PURE__ */ jsxs9("div", { className: "text-center py-8 text-red-500 dark:text-red-400 bg-red-50 dark:bg-red-900/30 rounded-lg", children: [
      /* @__PURE__ */ jsx19(Typography, { as: "p", tone: "danger", children: errorFetchMessage }),
      /* @__PURE__ */ jsx19(
        "button",
        {
          onClick: onReload,
          ...
          children: /* @__PURE__ */ jsx19(Typography, { as: "span", variant: "body-sm", tone: "danger", children: reloadLabel })
        }
      )
    ] }),
    !isLoading && !isError && /* @__PURE__ */ jsx19("div", { className: "space-y-3", children: hasItems ? children : /* @__PURE__ */ jsx19("div", { className: "text-center py-8 text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-lg animate-kui-fade-in", children: searchKeyword ? /* @__PURE__ */ jsx19(Typography, { as: "p", tone: "muted", children: noSearchResultsMessage }) : showOnlyIncomplete ? /* @__PURE__ */ jsx19(Typography, { as: "p", tone: "muted", children: noIncompleteMessage }) : /* @__PURE__ */ jsx19(Typography, { as: "p", tone: "muted", children: emptyMessage }) }) })
  ] });
};
  ...
  return /* @__PURE__ */ jsxs10("div", { className: cn("flex items-center gap-2", className), children: [
    ...
    /* @__PURE__ */ jsx20(
      "select",
      {
        ...
        children: monthOptions.map((option) => /* @__PURE__ */ jsx20("option", { value: option.value, children: option.label }, option.value))
      }
    ),
    /* @__PURE__ */ jsx20(
      "button",
...
var defaultRenderLink = ({
  ...
  className,
  onClick
}) => /* @__PURE__ */ jsx21("a", { href, className, onClick, children });
  ...
  return /* @__PURE__ */ jsxs11(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs11(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx21(DrawerHeader, { children: /* @__PURE__ */ jsx21(
            "button",
            {
              onClick: onClose,
          ...
          /* @__PURE__ */ jsxs11("div", { className: "overflow-y-auto h-full pb-16", children: [
            sections.map((section, sectionIndex) => /* @__PURE__ */ jsxs11("div", { children: [
              /* @__PURE__ */ jsx21("div", { className: "text-sm text-gray-500 dark:text-gray-400 px-4 pt-2", children: section.title }),
              section.items.map((item) => /* @__PURE__ */ jsx21("div", { className: "px-2", children: renderLink({
                href: item.path,
                ...
                children: /* @__PURE__ */ jsxs11(Fragment, { children: [
                  item.icon && /* @__PURE__ */ jsx21("span", { className: "text-gray-500 dark:text-gray-400 mr-3", children: item.icon }),
                  /* @__PURE__ */ jsx21("span", { children: item.name })
                ] })
              }) }, item.name))
            ] }, section.title || `section-${sectionIndex}`)),
            onLogout && /* @__PURE__ */ jsx21("div", { className: "px-2 mt-4", children: /* @__PURE__ */ jsx21(
              "button",
              {
                ...
                onClick: onLogout,
                children: /* @__PURE__ */ jsx21("span", { children: logoutLabel })
              }
            ) })
          ] })
        ]
...
var StatCards = ({
  ...
  return /* @__PURE__ */ jsx22("div", { className: cn("grid gap-4", columnStyles[columns], className), children: cards.map((card) => {
    ...
    return /* @__PURE__ */ jsxs12(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx22("h3", { className: cn("text-sm font-medium mb-1", styles.text), children: card.label }),
          /* @__PURE__ */ jsx22("p", { className: cn("text-2xl font-bold", styles.text), children: formatValue(card.value) })
        ]
      },
      card.label
    );
...
var AppLayout = ({
  ...
  const titleContent = /* @__PURE__ */ jsx24("span", { className: "text-xl font-bold text-primary-main dark:text-white", children: appTitle });
  const defaultRenderLink2 = ({
    href,
    children: linkChildren
  }) => /* @__PURE__ */ jsx24("a", { href, children: linkChildren });
  ...
  return /* @__PURE__ */ jsxs14("div", { className: "flex min-h-screen bg-white dark:bg-gray-900", children: [
    /* @__PURE__ */ jsx24(AppBar, { position: "fixed", color: appBarColor, className: "shadow-none", children: /* @__PURE__ */ jsxs14("div", { className: "flex items-center justify-between px-4 py-2", children: [
  ...
  return /* @__PURE__ */ jsxs15(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx25(Heading, { as: "h2", size: "md", children: title }),
        description ? /* @__PURE__ */ jsx25(Typography, { className: "max-w-md", variant: "body-sm", tone: "muted", children: description }) : null,
        action ? /* @__PURE__ */ jsx25("div", { className: "pt-1", children: action }) : null
      ]
    }
  );
};
